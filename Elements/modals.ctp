            ...
            <form class="form-horizontal" method="POST" data-ajax="true"
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <button type="submit"
                                    class="btn btn-secondary button"><?= $Lang->get('USER__LOGIN') ?></button>
...
<div class="modal modal-medium fade" id="lostpasswd" tabindex="-1" role="dialog" aria-labelledby="lostpasswdLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="card-footer">
                <button type="submit"
                        class="btn-mo button"><?= $Lang->get('USER__PASSWORD_FORGOT_SEND_MAIL') ?></button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-medium fade" id="lostpasswd2" tabindex="-1" role="dialog" aria-labelledby="lostpasswd2Label"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn-mo button"><?= $Lang->get('GLOBAL__SAVE') ?></button>
                    </form>
                </div>
            </div>
        </div>
